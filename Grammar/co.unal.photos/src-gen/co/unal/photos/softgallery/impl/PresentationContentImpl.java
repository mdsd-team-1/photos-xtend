 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.impl.PresentationContentImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PresentationContentImpl extends MinimalEObjectImpl.Container implements PresentationContent
{
  ...
  {
    return SoftgalleryPackage.Literals.PRESENTATION_CONTENT;
  }
  ...
  public EList<PresentationSegments> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<PresentationSegments>(PresentationSegments.class, this, SoftgalleryPackage.PRESENTATION_CONTENT__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.PRESENTATION_CONTENT__ELEMENTS:
