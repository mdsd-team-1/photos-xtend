 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.impl.TechnologiesImpl#getFactors <em>Factors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TechnologiesImpl extends MinimalEObjectImpl.Container implements Technologies
{
  ...
  {
    return SoftgalleryPackage.Literals.TECHNOLOGIES;
  }
  ...
  public EList<EObject> getFactors()
  {
    if (factors == null)
    {
      factors = new EObjectContainmentEList<EObject>(EObject.class, this, SoftgalleryPackage.TECHNOLOGIES__FACTORS);
    }
    return factors;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.TECHNOLOGIES__FACTORS:
