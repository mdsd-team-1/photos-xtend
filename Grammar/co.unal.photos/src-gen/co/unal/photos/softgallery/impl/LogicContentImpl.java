 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.impl.LogicContentImpl#getName <em>Name</em>}</li>
 *   <li>{@link co.unal.photos.softgallery.impl.LogicContentImpl#getLogiccomponents <em>Logiccomponents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicContentImpl extends MinimalEObjectImpl.Container implements LogicContent
{
  ...
  {
    return SoftgalleryPackage.Literals.LOGIC_CONTENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SoftgalleryPackage.LOGIC_CONTENT__NAME, oldName, name));
  }
  ...
  public EList<LogicStructure> getLogiccomponents()
  {
    ...
    {
      logiccomponents = new EObjectContainmentEList<LogicStructure>(LogicStructure.class, this, SoftgalleryPackage.LOGIC_CONTENT__LOGICCOMPONENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.LOGIC_CONTENT__LOGICCOMPONENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.LOGIC_CONTENT__NAME:
        return getName();
      case SoftgalleryPackage.LOGIC_CONTENT__LOGICCOMPONENTS:
