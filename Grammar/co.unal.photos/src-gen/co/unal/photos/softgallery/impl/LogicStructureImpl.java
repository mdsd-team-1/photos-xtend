 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.impl.LogicStructureImpl#getName <em>Name</em>}</li>
 *   <li>{@link co.unal.photos.softgallery.impl.LogicStructureImpl#getLogiccomponents <em>Logiccomponents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicStructureImpl extends MinimalEObjectImpl.Container implements LogicStructure
{
  ...
  {
    return SoftgalleryPackage.Literals.LOGIC_STRUCTURE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SoftgalleryPackage.LOGIC_STRUCTURE__NAME, oldName, name));
  }
  ...
  public EList<ComponentClass> getLogiccomponents()
  {
    ...
    {
      logiccomponents = new EObjectContainmentEList<ComponentClass>(ComponentClass.class, this, SoftgalleryPackage.LOGIC_STRUCTURE__LOGICCOMPONENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.LOGIC_STRUCTURE__LOGICCOMPONENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.LOGIC_STRUCTURE__NAME:
        return getName();
      case SoftgalleryPackage.LOGIC_STRUCTURE__LOGICCOMPONENTS:
