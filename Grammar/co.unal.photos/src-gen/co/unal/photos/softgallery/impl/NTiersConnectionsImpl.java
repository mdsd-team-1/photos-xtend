 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.impl.NTiersConnectionsImpl#getNtierconnection <em>Ntierconnection</em>}</li>
 *   <li>{@link co.unal.photos.softgallery.impl.NTiersConnectionsImpl#getName <em>Name</em>}</li>
 *   <li>{@link co.unal.photos.softgallery.impl.NTiersConnectionsImpl#getNtierorigin <em>Ntierorigin</em>}</li>
 *   <li>{@link co.unal.photos.softgallery.impl.NTiersConnectionsImpl#getNtiertarget <em>Ntiertarget</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NTiersConnectionsImpl extends MinimalEObjectImpl.Container implements NTiersConnections
{
  ...
  {
    return SoftgalleryPackage.Literals.NTIERS_CONNECTIONS;
  }
  ...
  public EList<String> getNtierconnection()
  {
    ...
    {
      ntierconnection = new EDataTypeEList<String>(String.class, this, SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERCONNECTION);
    }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SoftgalleryPackage.NTIERS_CONNECTIONS__NAME, oldName, name));
  }
  ...
  public EList<NTierSource> getNtierorigin()
  {
    if (ntierorigin == null)
    {
      ntierorigin = new EObjectContainmentEList<NTierSource>(NTierSource.class, this, SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERORIGIN);
    }
    return ntierorigin;
  }
  ...
  public EList<NTierTarget> getNtiertarget()
  {
    if (ntiertarget == null)
    {
      ntiertarget = new EObjectContainmentEList<NTierTarget>(NTierTarget.class, this, SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERTARGET);
    }
    return ntiertarget;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERORIGIN:
        return ((InternalEList<?>)getNtierorigin()).basicRemove(otherEnd, msgs);
      case SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERTARGET:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERCONNECTION:
        return getNtierconnection();
      case SoftgalleryPackage.NTIERS_CONNECTIONS__NAME:
        return getName();
      case SoftgalleryPackage.NTIERS_CONNECTIONS__NTIERORIGIN:
