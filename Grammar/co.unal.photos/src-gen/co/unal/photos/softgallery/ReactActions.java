 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.photos.softgallery.ReactActions#getReactactcontent <em>Reactactcontent</em>}</li>
 * </ul>
 *
 * @see co.unal.photos.softgallery.SoftgalleryPackage#getReactActions()
 * @model
 * @generated
 */
public interface ReactActions extends EObject
{
   ...
   * The list contents are of type {@link co.unal.photos.softgallery.ReactActionsContent}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Reactactcontent</em>' containment reference list.
   * @see co.unal.photos.softgallery.SoftgalleryPackage#getReactActions_Reactactcontent()
