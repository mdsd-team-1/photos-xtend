...
public class SoftGalleryLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SoftGalleryLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSpringTableIdAccess().getElementsAssignment_1(), "rule__SpringTableId__ElementsAssignment_1");
			...
			builder.put(grammarAccess.getForeignKeyRefAccess().getElementsAssignment_1(), "rule__ForeignKeyRef__ElementsAssignment_1");
