 ...
 *   <li>{@link co.unal.mdd.photos.dsl.softGalleryLanguage.Domain#getExceptionsdomain <em>Exceptionsdomain</em>}</li>
 * </ul>
 *
...
public interface Domain extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Exceptionsdomain</b></em>' containment reference list.
   * The list contents are of type {@link co.unal.mdd.photos.dsl.softGalleryLanguage.ExceptionsDomain}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Exceptionsdomain</em>' containment reference list.
   * @see co.unal.mdd.photos.dsl.softGalleryLanguage.SoftGalleryLanguagePackage#getDomain_Exceptionsdomain()
   * @model containment="true"
   * @generated
   */
  EList<ExceptionsDomain> getExceptionsdomain();
