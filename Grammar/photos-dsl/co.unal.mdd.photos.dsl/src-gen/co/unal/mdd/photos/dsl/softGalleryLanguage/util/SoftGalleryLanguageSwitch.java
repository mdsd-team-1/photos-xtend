...
public class SoftGalleryLanguageSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        ExceptionsDomain exceptionsDomain = (ExceptionsDomain)theEObject;
        T result = caseExceptionsDomain(exceptionsDomain);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        PhotoException photoException = (PhotoException)theEObject;
        T result = casePhotoException(photoException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SoftGalleryLanguagePackage.ALBUM_EXCEPTION:
      {
        AlbumException albumException = (AlbumException)theEObject;
        T result = caseAlbumException(albumException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SoftGalleryLanguagePackage.USER_EXCEPTION:
      {
        UserException userException = (UserException)theEObject;
        T result = caseUserException(userException);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Exceptions Domain</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Exceptions Domain</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseExceptionsDomain(ExceptionsDomain object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Photo Exception</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Photo Exception</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePhotoException(PhotoException object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Album Exception</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Album Exception</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAlbumException(AlbumException object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>User Exception</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>User Exception</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseUserException(UserException object)
  {
    return null;
  }
