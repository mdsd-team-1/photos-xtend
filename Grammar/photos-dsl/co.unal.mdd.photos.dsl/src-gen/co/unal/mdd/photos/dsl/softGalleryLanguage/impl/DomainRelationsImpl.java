 ...
 *   <li>{@link co.unal.mdd.photos.dsl.softGalleryLanguage.impl.DomainRelationsImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainRelationsImpl extends MinimalEObjectImpl.Container implements DomainRelations
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SoftGalleryLanguagePackage.DOMAIN_RELATIONS__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SoftGalleryLanguagePackage.DOMAIN_RELATIONS__ELEMENTS:
        return getElements();
      case SoftGalleryLanguagePackage.DOMAIN_RELATIONS__NAME:
        return getName();
    }
