 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.mdd.photos.dsl.softGalleryLanguage.impl.AmazonSimpleStorageServiceImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AmazonSimpleStorageServiceImpl extends MinimalEObjectImpl.Container implements AmazonSimpleStorageService
{
  ...
  {
    return SoftGalleryLanguagePackage.Literals.AMAZON_SIMPLE_STORAGE_SERVICE;
  }
  ...
  public EList<EObject> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<EObject>(EObject.class, this, SoftGalleryLanguagePackage.AMAZON_SIMPLE_STORAGE_SERVICE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftGalleryLanguagePackage.AMAZON_SIMPLE_STORAGE_SERVICE__ELEMENTS:
