 ...
 * </p>
 * <ul>
 *   <li>{@link co.unal.mdd.photos.dsl.softGalleryLanguage.impl.SpringBootApplicationImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpringBootApplicationImpl extends MinimalEObjectImpl.Container implements SpringBootApplication
{
  ...
  {
    return SoftGalleryLanguagePackage.Literals.SPRING_BOOT_APPLICATION;
  }
  ...
  public EList<EObject> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<EObject>(EObject.class, this, SoftGalleryLanguagePackage.SPRING_BOOT_APPLICATION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SoftGalleryLanguagePackage.SPRING_BOOT_APPLICATION__ELEMENTS:
